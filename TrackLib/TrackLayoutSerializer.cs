...
namespace TrackLib
{
    ...
    public class TrackLayoutSerializer
    {
        ...
        public void CreateTrackLayoutFile()
        {
            ...
            TrackBlock block1 = new TrackBlock("Block1", TrackOrientation.NorthSouth,100.00, false, false, TrackSignalState.SuperGreen, true, new BlockAuthority(100, 1), new Point(1, 1), 0, 100);
            TrackBlock block2 = new TrackBlock("Block22", TrackOrientation.NorthSouth, 100.00, false, false, TrackSignalState.SuperGreen, true, new BlockAuthority(100, 1), new Point(1, 101), 0, 100);
            TrackBlock block3 = new TrackBlock("Block333", TrackOrientation.NorthSouth, 100.00, false, true, TrackSignalState.SuperGreen, true, new BlockAuthority(100, 1), new Point(1, 201), 0, 100);
            TrackBlock block4 = new TrackBlock("Block4444", TrackOrientation.NorthSouth, 100.00, true, false, TrackSignalState.SuperGreen, true, new BlockAuthority(100, 1), new Point(1, 301), 0, 100);
